...
<%
	...
	String url = "jdbc:postgresql://localhost/ecommerce";
        ...
        ResultSet rs;
        String s;
        String sqlstr = "SELECT products.product_name,products.price,products.product_image,products.product_id,favori_products.favori_id FROM "+
                " products,favori_products WHERE "+
                " favori_products.product_id = products.product_id AND favori_products.user_id = "+userId+";";
        Statement st;
            ...
            <div style ="display: flex; flex-direction: column;" class="myDiv">
                <div>
                 ...
                 <div><button onclick="addBasket('<%=rs.getString(4)%>')" class="btn btn-warning">
                   ...
                   <button  onclick="favProductsDelete('<%=rs.getString(5)%>')" class="btn btn-danger">
