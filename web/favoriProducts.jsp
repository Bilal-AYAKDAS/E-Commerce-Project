...
<head>
    ...
    function favProductsDelete(favId){
        
        $.ajax({
            url: "ajaxFavProductsDel.jsp", 
            type: "GET",
            data: {
                favId: favId
            },
...
<body>
        ...
        <div style ="background-color: rgba(200, 200, 200, 0.5); display: flex; flex-direction: row;padding-left: 0px;">
            ...
            <div class="card" style="background-color:rgba(200, 200, 200, 0.5); margin-top: 5px; height:70px; width: 450px;  "><div class="card-body"> <h1 class="display-3" style="font-size:30px;">FAVORİ ÜRÜNLERİM</h1></div></div>
        <div style ="display: flex; flex-direction: row; padding-left: 0px;  margin-top: 15px;">        
